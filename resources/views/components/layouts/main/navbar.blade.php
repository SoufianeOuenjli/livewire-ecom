    ...
    <ul class="nav user-menu">
                    ...
                    <ul class="notification-list">
                        ...
                        <li class="notification-message">
                            <a href="#">
                                <div class="media">
                                    <span class="avatar avatar-sm">
                                        <img class="avatar-img rounded-circle" alt="User Image" src="{{asset('assets/img/patients/patient3.jpg')}}">
                                    </span>
                                    <div class="media-body">
        ...
        <li class="nav-item dropdown has-arrow">
            ...
            <div class="dropdown-menu">
                ...
                <form class="dropdown-item" method="POST" action="{{ route('logout') }}" class="w-full">
                    @csrf
