<div class="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-md">
    <h2 class="text-2xl font-semibold mb-4">{{ __('Modifier Client') }}</h2>
    ...
    <form  wire:submit.prevent="save">
        ...
        <div class="flex justify-between">
            ...
            <a href="{{ route('clients.index') }}" class="text-gray-500 hover:text-gray-700" wire:navigate>{{ __('Retour') }}</a>
        </div>
    </form>
</div>
